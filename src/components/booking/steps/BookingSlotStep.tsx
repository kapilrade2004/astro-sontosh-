...
import {
    ...
    Moon, MapPin, TrendingUp, Compass, Brain, DollarSign, Plane,
} from "lucide-react";

// ── Micro / Quick Service pricing ────────────────────────────────
// Matches quickServices.ts exactly. "Premium Kundli" removed per client instruction.
const microPricingData = [
    // ₹500 tier
    { service: "Lucky Day / Date Finder (for any task)",          price: "500",  icon: Star        },
    ...
    { service: "Rudraksha Suitability Check",                     price: "500",  icon: Gem         },
    { service: "Crystal Suitability Check",                       price: "500",  icon: Gem         },
    // ₹1100 tier
    ...
    { service: "Career Direction Quick Check",                    price: "1,100", icon: Briefcase   },
    { service: "Sleep / Stress Astrology Insight",                price: "1,100", icon: Moon        },
    { service: "Simple Remedy Suggestion (1–2 Actions)",          price: "1,100", icon: Sparkles    },
    { service: "Tattoo Suitability Check",                        price: "1,100", icon: Zap         },
    ...
    { service: "Marriage – MatchMaking",                          price: "2,100", icon: Heart       },
    ...
    { service: "Gemstone Suitability Check (Basic)",              price: "2,100", icon: Gem         },
...
// Prices updated to match screenshot: ₹11,000 / ₹15,000 / ₹15,000 / ₹3,100 / ₹5,100
// "Premium Kundli" row removed per client instruction.
const newPricingData = [
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 md:space-y-8">
            <div className="grid grid-cols-1 xl:grid-cols-[1.3fr_0.7fr] gap-4 lg:gap-5 max-w-full xl:max-w-5xl">
                ...
                <div className="space-y-4">
                    ...
                    {/* Time of Birth — shown for astrology + numerology + premium kundli */}
