...
const microPricingData = [
    { service: "Daily Ritual Suggestion (Simple Routine)",        price: "1,100", icon: Moon        },
    { service: "Go Ahead or Wait Decision Guidance",              price: "1,100", icon: Compass     },
    { service: "Right Time Check (Shubh Time for Any Decision)",  price: "1,100", icon: Clock       },
    { service: "Ask 1 Question (Yes/No + Reason)",                price: "2,100", icon: MessageCircle },
    { service: "Relationship Guidance",                           price: "2,100", icon: Heart       },
    { service: "Family Issue Insight",                            price: "2,100", icon: Heart       },
    { service: "Love Situation Guidance",                         price: "2,100", icon: Heart       },
    { service: "Opportunity Check (Anything good coming soon?)",  price: "2,100", icon: TrendingUp  },
    { service: "Sleep / Stress Related Insight",                  price: "2,100", icon: Moon        },
    { service: "Strength Insight (Hidden Strengths)",             price: "2,100", icon: Brain       },
    { service: "Name Initial Suggestion (for business/personal)", price: "2,100", icon: Hash        },
    { service: "Property Buying Time Check",                      price: "2,100", icon: Home        },
    { service: "Muhurat – Auspicious Timing",                     price: "2,100", icon: Star        },
    { service: "Know Your Lucky Days & Colours",                  price: "2,100", icon: Star        },
    { service: "Rudraksha / Crystal Recommendation",              price: "2,100", icon: Gem         },
    { service: "Tattoo Recommendation",                           price: "2,100", icon: Zap         },
    { service: "New Born Baby Name Recommendation",               price: "2,100", icon: Baby        },
    { service: "Compatibility Check",                             price: "3,100", icon: Heart       },
    { service: "Job Change Decision Guidance",                    price: "3,100", icon: Briefcase   },
    { service: "Money Flow Guidance",                             price: "3,100", icon: DollarSign  },
    { service: "Career Guidance",                                 price: "3,100", icon: Briefcase   },
    { service: "Travel / Relocation Decision Check",              price: "3,100", icon: Plane       },
    { service: "Gemstone Recommendation",                         price: "3,100", icon: Gem         },
    { service: "Lifestyle & Behavioural Recommendation",          price: "3,100", icon: Heart       },
    { service: "Premium Kundli",                                  price: "3,100", icon: Scroll      },
];
