...
const repeatPricingData = [
    ...
    { service: "Numerology Follow-up (within 10 days)", price: "1,100", duration: "30 min", icon: Repeat },
    { service: "Numerology Follow-up (11-30 days)", price: "2,100", duration: "30 min", icon: Repeat },
    { service: "Numerology Follow-up (post 30 days)", price: "3,100", duration: "30 min", icon: Repeat },
];
