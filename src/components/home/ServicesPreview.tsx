...
const services = [
  {
    icon: Stars,
    title: "Astrology",
    description: "Unlock your destiny through detailed birth chart analysis. Get insights on career, marriage, health, and major life events with precise timing predictions.",
    path: "/astrology",
  ...
  },
  {
    icon: Hash,
    title: "Numerology",
    description: "Discover the hidden power of numbers in your life. From mobile number analysis to name correction, align your vibrations for success.",
    path: "/numerology",
  ...
  },
  {
    icon: Home,
    title: "Vastu Shastra",
    description: "Harmonize your living and working spaces with Vastu. Balance the five elements to invite prosperity, health, and peace into your life.",
    path: "/vastu",
  ...
  },
  {
    icon: Hand,
    title: "Palmistry",
    description: "Your palms hold the roadmap of your life. Get detailed readings of your life line, heart line, and more with personalized remedies.",
    path: "/palmistry",
